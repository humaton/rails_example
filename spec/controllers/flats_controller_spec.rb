...
describe FlatsController do
  ...
  describe "GET new" do
    it "assigns a new flat as @flat" do
      ...
      assigns(:flat).should be_a_new(Flat)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created flat as @flat" do
        post :create, {:flat => valid_attributes}, valid_session
        assigns(:flat).should be_a(Flat)
        assigns(:flat).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved flat as @flat" do
        ...
        Flat.any_instance.stub(:save).and_return(false)
        post :create, {:flat => {}}, valid_session
        assigns(:flat).should be_a_new(Flat)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested flat" do
        flat = Flat.create! valid_attributes
        # Assuming there are no other flats in the database, this
        # specifies that the Flat created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Flat.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => flat.to_param, :flat => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the flat" do
        flat = Flat.create! valid_attributes
        put :update, {:id => flat.to_param, :flat => valid_attributes}, valid_session
        response.should redirect_to(flat)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the flat as @flat" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Flat.any_instance.stub(:save).and_return(false)
        put :update, {:id => flat.to_param, :flat => {}}, valid_session
        assigns(:flat).should eq(flat)
      end
